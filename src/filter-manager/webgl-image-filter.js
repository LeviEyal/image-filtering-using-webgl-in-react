const OS_FILETR_RANGE = [0, 2];
const OS_FILETR_LIGHTNESS = 1;
const O2_FILETR_RANGE = [2, 256];
const O2_FILETR_LIGHTNESS = 1;
const EMBOSS_FILETR_AMOUNT = 1;
const SHARPEN_FILETR_AMOUNT = 2;
...
export class WebGLProgram {
  ...
  export var WebGLImageFilter = (window.WebGLImageFilter = function (params) {
    ...
    _filter.osFilter = function () {
      ...
      const _hue_range = OS_FILETR_RANGE;
      const _lightness_for_deleted = OS_FILETR_LIGHTNESS;
    ...
    _filter.O2Filter = function () {
      ...
      const _hue_range = O2_FILETR_RANGE;
      const _lightness_for_deleted = O2_FILETR_LIGHTNESS;
      gl.uniform2f(program.uniform.hue_range, _hue_range[0], _hue_range[1]);
      gl.uniform1f(program.uniform.lightness_for_deleted, _lightness_for_deleted);
      _draw();
    };
